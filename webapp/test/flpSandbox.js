		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#fragment1fragmentproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fragment1fragmentproject1-display": {
								"semanticObject": "fragment1fragmentproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fragment1.fragmentproject1",
									"url": sap.ui.require.toUrl("fragment1/fragmentproject1")
								}
							}
						}
					}
